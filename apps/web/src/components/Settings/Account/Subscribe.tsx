    ...
    <Card>
      ...
      >
        <div className="text-lg font-bold">
          <Trans>Set Subscription</Trans>
        </div>
        <p>
          <Trans>
            Setting Subscription makes users spend crypto on monthly basis to
            subscribe to your exclusive content, and it's a good way to earn,
            you can change the amount and currency or disable/enable it anytime.
          </Trans>
        </p>
        <TextArea
          label={t`User Content`}
          placeholder="This Content will be visible to user who are willing to subscribe to your content"
        ...
        <Input
          label={t`Subscription amount per month`}
          type="number"
          step="0.0001"
          min="0"
          max="100000"
